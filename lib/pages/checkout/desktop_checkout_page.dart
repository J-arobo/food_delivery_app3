...
class _DesktopCheckoutPageState extends State<DesktopCheckoutPage> {
  ...
  void _editAddress(int index) {
    final ctrl = TextEditingController(text: _addresses[index]['address']);
            ...
            onPressed: () {
              setState(() {
                _addresses[index] = {
                  ...
                  'address': ctrl.text.trim().isEmpty ? _addresses[index]['address']! : ctrl.text.trim(),
                };
              });
        ...
        children: [
          ...
          _card(Column(
            ...
            children: [
              ...
              if (_promoDiscount > 0) ...[
                SizedBox(height: 8),
                _row('Promo ($_appliedPromo)', '− KSh $_promoDiscount', valueColor: Colors.green.shade600),
              ],
