...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition =
      const CameraPosition(target: LatLng(-1.2846464, 36.8199579), zoom: 17);
  late LatLng _initialPosition = LatLng(-1.2846464, 36.8199579);

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    _islogged = Get.find<AuthController>().userLoggerIn();
    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(builder: (userController) {
        ...
        return GetBuilder<LocationController>(builder: (locationController) {
          ...
          print("adress in my view is now ${_addressController.text}");
                    ...
                    onTap: () {
                      ...
                      locationController
                        ...
                        if (response.isSuccess) {
                          ...
                          Get.snackbar(
                              "Address", "Could not have saved address");
                        }
                      });
                    },
                    child: Container(
